...
execute if data storage pandamium:temp selected_lore unless data storage pandamium:temp {selected_lore:'{"text":""}'} unless data storage pandamium:temp {selected_lore:'""'} run return 1
